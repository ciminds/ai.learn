...
window.initiatePayment = function() {
    ...
    if (!RAZORPAY_KEY_ID || RAZORPAY_KEY_ID.endsWith('_') || RAZORPAY_KEY_ID === 'rzp_live_') { showToast('Payment gateway not configured. Contact support@cbkminds.com', 'error'); console.error('[CBK] Razorpay key not configured'); return; }
    ...
    const options = {
        ...
        handler: async function(response) {
            if (!response.razorpay_payment_id) {
                showToast('Payment could not be verified. Contact support@cbkminds.com', 'error');
                resetEnrollBtn();
                return;
            }
