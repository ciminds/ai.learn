...
const COURSE_AMOUNT = 9900;
const COURSE_NAME   = 'AI Fast-Track — CI Minds';
...
window.initiatePayment = function() {
    ...
    if (!RAZORPAY_KEY_ID || RAZORPAY_KEY_ID.endsWith('_')) { showToast('Payment gateway not configured.', 'error'); return; }
